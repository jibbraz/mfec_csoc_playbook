...
def authreqtofortimanager(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortimanager bbt vayu x'], callback=getauthsessionid, name="authreqtofortimanager")
...
def deleteaddrobj(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortimanager bbt vayu x'], callback=reqinstallpolicypackage, name="deleteaddrobj")
...
def deladdrobjfromaddrgrp(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortimanager bbt vayu x'], callback=reqdeladdrobj, name="deladdrobjfromaddrgrp")
	...
	\"params\": [
		{{
            ...
            \"data\": [
                {{
                    \"adom\": \"root\",
                    \"pkg\": \"BBT-DC2_DH1_R501_U35-36-3301E-FW_Internet\",
                    \"scope member\": [
                        {{
                            \"name\": \"BBT-DC2_DH1_R501_U35-36-3301E-FW\",
                            \"vdom\": \"internet\"
                        }}
                    ],
                    \"flags\": \"none\"
...
def installpolicypackage(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortimanager bbt vayu x'], callback=cf_local_waittime_1, name="installpolicypackage")
...
<b>Uncontainment Destination IP Address:</b> {0}
<b>Execute Time:</b> {1}
...
def veritytaskstatus(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortimanager bbt vayu x'], callback=cf_community_datetime_modify_1, name="veritytaskstatus")
