...
def addObject2Group(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortigate-aci (session-based)'], callback=sleep_2, name="addObject2Group")
...
def createObjectS(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortigate-aci (session-based)'], callback=sleep, name="createObjectS")
    ...
    for container_item in container_data:
        if container_item[0]:
            parameters.append({
                ...
                'tags': "",
                'label': "",
                'cef_json': "{\"destinationAddress_ContainResult_Fortigate_ACI\":\"False\"}",
                'severity': "",
                'overwrite': False,
    ...
    for container_item in container_data:
        if container_item[0]:
            parameters.append({
                ...
                'tags': "",
                'label': "",
                'cef_json': "{\"destinationAddress_ContainResult_Fortigate_ACI\":\"True\"}",
                'severity': "",
                'overwrite': False,
                'artifact_id': container_item[0],
                'artifact_json': "",
...
def checkObjectExists(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="get data", parameters=parameters, assets=['fortigate-aci (session-based)'], callback=decision_3, name="checkObjectExists")
...
def add2group_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortigate-aci (session-based)'], callback=logout3, name="add2group_2")
...
def logout3(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortigate-aci (session-based)'], callback=addObject2GrpSuccess2, name="logout3", parent_action=action)
...
def logout(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortigate-aci (session-based)'], callback=addObjectFail, name="logout")
