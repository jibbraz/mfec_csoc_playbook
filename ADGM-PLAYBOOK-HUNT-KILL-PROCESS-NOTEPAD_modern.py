...
def executetaskkillprocesscalcuri(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    template = """/ASDK.Task/TaskManagementService.asmx/ExecuteTask?taskGuid=5c6afd3b-a4ca-4cbd-8ee5-70b7105d4889&executionName=CSOC-ThreatHunter-Response&inputParameters=<inputParameters><parameter><name>@AssignedResources</name><value>{0}</value></parameter></inputParameters>"""
