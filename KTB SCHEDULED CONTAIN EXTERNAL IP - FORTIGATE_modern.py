...
def on_start(container):
    ...
    # call 'playbook_local_KTB_CHILD_SCHEDULED_CONTAIN_EXTERNAL_IP_FORTIGATE_SRC_1' block
    playbook_local_KTB_CHILD_SCHEDULED_CONTAIN_EXTERNAL_IP_FORTIGATE_SRC_1(container=container)

    return

@phantom.playbook_block()
def playbook_local_KTB_CHILD_SCHEDULED_CONTAIN_EXTERNAL_IP_FORTIGATE_SRC_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('playbook_local_KTB_CHILD_SCHEDULED_CONTAIN_EXTERNAL_IP_FORTIGATE_SRC_1() called')
    
    # call playbook "local/KTB CHILD SCHEDULED CONTAIN EXTERNAL IP - FORTIGATE SRC", returns the playbook_run_id
    playbook_run_id = phantom.playbook(playbook="local/KTB CHILD SCHEDULED CONTAIN EXTERNAL IP - FORTIGATE SRC", container=container, name="playbook_local_KTB_CHILD_SCHEDULED_CONTAIN_EXTERNAL_IP_FORTIGATE_SRC_1", callback=decision_1)

    return

@phantom.playbook_block()
def playbook_local_KTB_CHILD_SCHEDULED_CONTAIN_EXTERNAL_IP_FORTIGATE_DEST_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('playbook_local_KTB_CHILD_SCHEDULED_CONTAIN_EXTERNAL_IP_FORTIGATE_DEST_1() called')
    
    # call playbook "local/KTB CHILD SCHEDULED CONTAIN EXTERNAL IP - FORTIGATE DEST", returns the playbook_run_id
    playbook_run_id = phantom.playbook(playbook="local/KTB CHILD SCHEDULED CONTAIN EXTERNAL IP - FORTIGATE DEST", container=container, name="playbook_local_KTB_CHILD_SCHEDULED_CONTAIN_EXTERNAL_IP_FORTIGATE_DEST_1", callback=get_src_ip_containment_status)

    return

@phantom.playbook_block()
def join_playbook_local_KTB_CHILD_SCHEDULED_CONTAIN_EXTERNAL_IP_FORTIGATE_DEST_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
...
def decision_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    join_playbook_local_KTB_CHILD_SCHEDULED_CONTAIN_EXTERNAL_IP_FORTIGATE_DEST_1(action=action, success=success, container=container, results=results, handle=handle, custom_function=custom_function)
