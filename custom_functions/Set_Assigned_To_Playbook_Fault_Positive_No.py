def Set_Assigned_To_Playbook_Fault_Positive_No(container_id=None, **kwargs):
    """
    Args:
    ...
    update_dict = {'custom_fields':{'False Positive': "No", 'Closure Type': "auto", 'Assigned To': "Playbook"}}
