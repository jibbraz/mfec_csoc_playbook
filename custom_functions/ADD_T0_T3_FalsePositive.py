def ADD_T0_T3_FalsePositive(container_id_now=None, **kwargs):
    """
    Set T0 default value - T3
    ...
    class ADD_T0_T3_FalsePositive:
        ...
        def CF_PAYLOAD(self, cont_id):
            ...
            result["False Positive"] = "Yes"
            result["Detection Technology"] = "Others" 
            result["Incident Type"] = "Others"             
            payload = json.dumps(
    ...
    ADD_ACTION= ADD_T0_T3_FalsePositive()
