...
def authen_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortigate-internet (session-based)'], callback=cf_local_prepare_fortigate_cookie_header_2, name="authen_2")
...
def cf_local_prepare_fortigate_cookie_header_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.custom_function(custom_function='local/prepare_fortigate_cookie_header', parameters=parameters, name='cf_local_prepare_fortigate_cookie_header_2', callback=cf_community_datetime_modify_1)
...
def deleteobjectInGroup(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="delete data", parameters=parameters, assets=['fortigate-internet (session-based)'], callback=decision_1, name="deleteobjectInGroup")
...
def deleteobject(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="delete data", parameters=parameters, assets=['fortigate-internet (session-based)'], callback=sleep_5, name="deleteobject")
    ...
    for container_item in container_data:
        if container_item[0]:
            parameters.append({
                ...
                'tags': "",
                'label': "",
                'cef_json': "{\"destinationAddress_UncontainResult_Fortigate_Internet\" : \"False\"}",
                'severity': "",
                'overwrite': False,
    ...
    for container_item in container_data:
        if container_item[0]:
            parameters.append({
                ...
                'tags': "",
                'label': "",
                'cef_json': "{\"destinationAddress_UncontainResult_Fortigate_Internet\" : \"True\"}",
                'severity': "",
                'overwrite': False,
                'artifact_id': container_item[0],
                'artifact_json': "",
...
def logout(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortigate-internet (session-based)'], callback=deleteobjectFromGrpFail, name="logout")
    ...
    for container_item in container_data:
        if container_item[0]:
            parameters.append({
                ...
                'artifact_id': container_item[0],
                'artifact_json': "",
                'cef_types_json': "{\"destinationAddress_UncontainResult_Fortigate_Internet\" : \"False\"}",
                # context (artifact id) is added to associate results with the artifact
                'context': {'artifact_id': container_item[1]},
            })
