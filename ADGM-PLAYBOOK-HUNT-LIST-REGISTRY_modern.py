...
def checkclientexist(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    executetaskgetregistryuri(action=action, success=success, container=container, results=results, handle=handle, custom_function=custom_function)
...
@phantom.playbook_block()
def executetaskgetregistryuri(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('executetaskgetregistryuri() called')
    
    template = """/ASDK.Task/TaskManagementService.asmx/executetask?taskGuid=4a38fc11-e064-465c-8557-fa0454e6c75a&executionName=CSOC-ThreatHunter-Response&inputParameters=<inputParameters><parameter><name>@AssignedResources</name><value>{0}</value></parameter></inputParameters>"""
    ...
    phantom.format(container=container, template=template, parameters=parameters, name="executetaskgetregistryuri", separator=", ")
...
def executetask(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    formatted_data_1 = phantom.get_format_data(name='executetaskgetregistryuri')
...
def addnotetoevent(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    note_title = "List of registry key"
