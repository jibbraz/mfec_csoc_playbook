...
def addObject2Group(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    custom_function_results_data_1 = phantom.collect2(container=container, datapath=['cf_local_prepare_Fortigate_Cookie_Header_v7210_2:custom_function_result.data.header'], action_results=results)
...
def authen(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortigate-dev (session-based)'], callback=cf_local_prepare_Fortigate_Cookie_Header_v7210_2, name="authen")
...
def cf_local_prepare_Fortigate_Cookie_Header_v7210_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('cf_local_prepare_Fortigate_Cookie_Header_v7210_2() called')
    ...
    phantom.custom_function(custom_function='local/prepare_Fortigate_Cookie_Header_v7210', parameters=parameters, name='cf_local_prepare_Fortigate_Cookie_Header_v7210_2', callback=cf_community_datetime_modify_1)
