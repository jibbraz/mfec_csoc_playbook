...
def preparedeleteingroupurl(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    template = """api/v2/cmdb/firewall/addrgrp/phantom-blacklist/member/Phantom {0}_32?vdom=Internet"""
...
def authen_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortigate-internet-dr (session-based)'], callback=cf_local_prepare_fortigate_cookie_header_v725_2, name="authen_2")

    return

@phantom.playbook_block()
def cf_local_prepare_fortigate_cookie_header_v725_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('cf_local_prepare_fortigate_cookie_header_v725_2() called')
    ...
    phantom.custom_function(custom_function='local/prepare_fortigate_cookie_header_v725', parameters=parameters, name='cf_local_prepare_fortigate_cookie_header_v725_2', callback=cf_community_datetime_modify_1)
...
def deleteobjectingroup(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    custom_function_results_data_1 = phantom.collect2(container=container, datapath=['cf_local_prepare_fortigate_cookie_header_v725_2:custom_function_result.data.header'], action_results=results)
    ...
    phantom.act(action="delete data", parameters=parameters, assets=['fortigate-internet-dr (session-based)'], callback=decision_1, name="deleteobjectingroup")
...
def deleteobject(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="delete data", parameters=parameters, assets=['fortigate-internet-dr (session-based)'], callback=sleep_5, name="deleteobject")
    ...
    for container_item in container_data:
        if container_item[0]:
            parameters.append({
                ...
                'tags': "",
                'label': "",
                'cef_json': "{\"sourceAddress_UncontainResult_Fortigate_Internet\" : \"False\"}",
                'severity': "",
                'overwrite': False,
    ...
    for container_item in container_data:
        if container_item[0]:
            parameters.append({
                ...
                'tags': "",
                'label': "",
                'cef_json': "{\"sourceAddress_UncontainResult_Fortigate_Internet\" : \"True\"}",
                'severity': "",
                'overwrite': False,
                'artifact_id': container_item[0],
                'artifact_json': "",
...
def logout(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortigate-internet-dr (session-based)'], callback=deleteobjectfromgrpfail, name="logout")
    ...
    for container_item in container_data:
        if container_item[0]:
            parameters.append({
                ...
                'artifact_id': container_item[0],
                'artifact_json': "",
                'cef_types_json': "{\"sourceAddress_UncontainResult_Fortigate_Internet\" : \"False\"}",
                # context (artifact id) is added to associate results with the artifact
                'context': {'artifact_id': container_item[1]},
            })
