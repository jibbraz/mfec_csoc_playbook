    ...
    for custom_function_results_item_1 in custom_function_results_data_1:
        if custom_function_results_item_1[0]:
            parameters.append({
                'body': custom_function_results_item_1[0],
                'headers': "",
                'location': "webfilter/ftgd-local-rating?vdom=ATP-Seg-1&access_token=mG9gr56ny7rrz4mdssq11gnkf6wgxd",
                'verify_certificate': False,
            })
    ...
    for custom_function_results_item_1 in custom_function_results_data_1:
        if custom_function_results_item_1[0]:
            parameters.append({
                'body': custom_function_results_item_1[0],
                'headers': "",
                'location': "webfilter/ftgd-local-rating?vdom=ATP-Seg-1&access_token=7sjwb4s7m95kmQfjG58r3dkw0GH1hN",
                'verify_certificate': False,
            })
    ...
    for custom_function_results_item_1 in custom_function_results_data_1:
        if custom_function_results_item_1[0]:
            parameters.append({
                'body': custom_function_results_item_1[0],
                'headers': "",
                'location': "webfilter/ftgd-local-rating?vdom=ATP-Seg-2&access_token=7sjwb4s7m95kmQfjG58r3dkw0GH1hN",
                'verify_certificate': False,
            })
