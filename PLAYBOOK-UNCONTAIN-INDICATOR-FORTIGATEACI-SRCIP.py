    ...
    for container_item in container_data:
        if container_item[0]:
            parameters.append({
                ...
                'tags': "",
                'label': "",
                'cef_json': "{\"sourceAddress_UncontainResult_Fortigate_ACI\" : \"False\"}",
                'severity': "",
                'overwrite': False,
    ...
    for container_item in container_data:
        if container_item[0]:
            parameters.append({
                ...
                'tags': "",
                'label': "",
                'cef_json': "{\"sourceAddress_UncontainResult_Fortigate_ACI\" : \"True\"}",
                'severity': "",
                'overwrite': False,
                'artifact_id': container_item[0],
                'artifact_json': "",
    ...
    for container_item in container_data:
        if container_item[0]:
            parameters.append({
                ...
                'artifact_id': container_item[0],
                'artifact_json': "",
                'cef_types_json': "{\"sourceAddress_UncontainResult_Fortigate_ACI\" : \"False\"}",
                # context (artifact id) is added to associate results with the artifact
                'context': {'artifact_id': container_item[1]},
            })
