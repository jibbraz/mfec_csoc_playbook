...
def addobject2group(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortigate-internet (session-based)'], callback=sleep_2, name="addobject2group")
...
def authen(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortigate-internet (session-based)'], callback=cf_local_prepare_fortigate_cookie_header_1, name="authen")
...
def createobjects(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortigate-internet (session-based)'], callback=sleep, name="createobjects")
...
def cf_local_prepare_fortigate_cookie_header_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.custom_function(custom_function='local/prepare_fortigate_cookie_header', parameters=parameters, name='cf_local_prepare_fortigate_cookie_header_1', callback=cf_community_datetime_modify_1)
    ...
    for container_item in container_data:
        if container_item[0]:
            parameters.append({
                ...
                'tags': "",
                'label': "",
                'cef_json': "{\"sourceAddress_ContainResult_Fortigate_Internet\":\"False\"}",
                'severity': "",
                'overwrite': False,
    ...
    for container_item in container_data:
        if container_item[0]:
            parameters.append({
                ...
                'tags': "",
                'label': "",
                'cef_json': "{\"sourceAddress_ContainResult_Fortigate_Internet\":\"True\"}",
                'severity': "",
                'overwrite': False,
                'artifact_id': container_item[0],
                'artifact_json': "",
...
def logout_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortigate-internet (session-based)'], callback=decision_2, name="logout_2", parent_action=action)
...
def checkobjectexists(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="get data", parameters=parameters, assets=['fortigate-internet (session-based)'], callback=decision_3, name="checkobjectexists")
...
def add2group_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortigate-internet (session-based)'], callback=logout3, name="add2group_2")
...
def logout3(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortigate-internet (session-based)'], callback=addobject2grpsuccess2, name="logout3", parent_action=action)
...
def logout(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortigate-internet (session-based)'], callback=addobjectfail, name="logout")
