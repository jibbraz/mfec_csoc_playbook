...
def authen_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortigate-internet-dr (session-based)'], callback=cf_local_prepare_fortigate_cookie_header_v725_1, name="authen_2")

    return

@phantom.playbook_block()
def cf_local_prepare_fortigate_cookie_header_v725_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
