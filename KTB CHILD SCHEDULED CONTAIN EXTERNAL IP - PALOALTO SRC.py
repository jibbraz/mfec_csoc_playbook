...
def Get_the_top_IP_address_from_the_list(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    import ipaddress
    success, message, iplist = phantom.get_list(list_name='PaloAlto - Src IP to contain')
    for ip in iplist:
        try:
...
def decision_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    if matched:
        Palo_Alto_Block_Src_IP(action=action, success=success, container=container, results=results, handle=handle, custom_function=custom_function)
        return
...
def Remove_the_top_IP_address_from_the_list(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.delete_from_list(list_name="PaloAlto - Src IP to contain", value=Get_the_top_IP_address_from_the_list__top_ip_address, column=None, remove_all=False, remove_row=False)
    success, message, iplist = phantom.get_list(list_name='PaloAlto - Src IP to contain')
    for ip in iplist:
        try:
            ipaddress.ip_address(ip[0])
...
def Add_Note_for_the_result(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    parameters.append({
        'title': "Source Address: Result Summary",
        'content': content,
        'container_id': "",
        'phase_id': "",
    })
...
def Save_the_result_to_global_var(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    results_data_1 = phantom.collect2(container=container, datapath=['Palo_Alto_Block_Src_IP:action_result.parameter.ip', 'Palo_Alto_Block_Src_IP:action_result.status'], action_results=results)
...
"""
Palo Alto Block Src IP
"""
def Palo_Alto_Block_Src_IP(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('Palo_Alto_Block_Src_IP() called')
        
    #phantom.debug('Action: {0} {1}'.format(action['name'], ('SUCCEEDED' if success else 'FAILED')))
    
    Get_the_top_IP_address_from_the_list__top_ip_address = json.loads(phantom.get_run_data(key='Get_the_top_IP_address_from_the_list:top_ip_address'))
    # collect data for 'Palo_Alto_Block_Src_IP' call

    parameters = []
    
    # build parameters list for 'Palo_Alto_Block_Src_IP' call
    parameters.append({
    ...
    phantom.act(action="block ip", parameters=parameters, assets=['cxapp_palo-dc1-asset','cxapp_palo-dr1-asset','cxapp_palo-vpndc-asset','cxapp_palo-vpndr-asset'], callback=Save_the_result_to_global_var, name="Palo_Alto_Block_Src_IP")
