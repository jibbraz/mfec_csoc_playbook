...
def CheckClientExist(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    ExecuteTaskGetProcessURI(action=action, success=success, container=container, results=results, handle=handle, custom_function=custom_function)
...
def ExecuteTaskGetProcessURI(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('ExecuteTaskGetProcessURI() called')
    
    template = """/ASDK.Task/TaskManagementService.asmx/ExecuteTask?taskGuid=012c4bcc-4969-4124-8af2-c8e25ed0fd99&executionName=CSOC-ThreatHunter-Response&inputParameters=<inputParameters><parameter><name>@AssignedResources</name><value>{0}</value></parameter></inputParameters>"""
    ...
    phantom.format(container=container, template=template, parameters=parameters, name="ExecuteTaskGetProcessURI", separator=", ")
...
def ExecuteTask(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    formatted_data_1 = phantom.get_format_data(name='ExecuteTaskGetProcessURI')
...
def AddNoteToEvent(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    note_title = "List of process running"
