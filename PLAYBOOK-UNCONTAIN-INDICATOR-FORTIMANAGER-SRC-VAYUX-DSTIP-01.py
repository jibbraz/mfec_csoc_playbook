...
def AuthReqToFortiManager(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortimanager src vayu x'], callback=GetAuthSessionID, name="AuthReqToFortiManager")
...
def DeleteAddrObj(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortimanager src vayu x'], callback=ReqInstallPolicyPackage, name="DeleteAddrObj")
...
def DelAddrObjFromAddrGrp(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortimanager src vayu x'], callback=ReqDelAddrObj, name="DelAddrObjFromAddrGrp")
	...
	\"params\": [
		{{
            ...
            \"data\": [
                {{
                    \"adom\": \"root\",
                    \"pkg\": \"SRC-COLO3_R101_U35-36-3301E-FW_Internet\",
                    \"scope member\": [
                        {{
                            \"name\": \"SRC-COLO3_R101_U35-36-3301E-FW\",
                            \"vdom\": \"internet\"
                        }}
                    ],
                    \"flags\": \"none\"
...
def InstallPolicyPackage(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortimanager src vayu x'], callback=cf_local_waittime_1, name="InstallPolicyPackage")
...
def VerityTaskStatus(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="post data", parameters=parameters, assets=['fortimanager src vayu x'], callback=cf_community_datetime_modify_1, name="VerityTaskStatus")
